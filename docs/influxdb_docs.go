...
// SwaggerInfoinfluxdb holds exported Swagger Info so clients can modify it
var SwaggerInfoinfluxdb = &swag.Spec{
	Version:          "1.0 版本",
	Host:             "",
	...
	Title:            "历史数据库接口文档",
	Description:      "API文档",
	InfoInstanceName: "influxdb",
	SwaggerTemplate:  docTemplateinfluxdb,
}

func init() {
	swag.Register(SwaggerInfoinfluxdb.InstanceName(), SwaggerInfoinfluxdb)
}
